...
async function relationalQuery(
  ...
  if (type === 'fullPath') {
    ...
    nameColumn = `case when website_event.referrer_query != '' then website_event.referrer_domain || website_event.referrer_path || '?' || website_event.referrer_query else website_event.referrer_domain || website_event.referrer_path end`;
  }
